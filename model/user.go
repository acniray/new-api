...
type User struct {
	...
	Group            string         `json:"group" gorm:"type:varchar(64);default:'普通用户'"`
	...
	Phone            string         `json:"phone" gorm:"type:varchar(32);column:phone;index"`
	CreatorId        int            `json:"creator_id" gorm:"type:int;column:creator_id;index"`
